...
class ImageCropper {
  ...
  setupEventListeners() {
    ...
    const profileContainers = document.querySelectorAll(
      ".profile-photo-container, .clickeable-photo",
    );
      ...
      (blob) => {
        ...
        this.saveImageToServer(blob, dataUrl)
          .then(() => {
            ...
            this.showMessage(
              "Imagen guardada exitosamente. Recargando página...",
              "success",
            );
  ...
  updateAllProfileImages(imageUrl) {
    ...
    const mainProfilePlaceholders = document.querySelectorAll(
  ...
  cancelCrop() {
    ...
    this.showMessage(
      "Operación cancelada. Puedes seleccionar otra imagen.",
      "info",
    );
  }
